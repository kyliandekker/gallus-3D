...
namespace gallus::graphics::imgui
{
	...
	void HierarchyWindow::Render()
	{
		...
		if (CanActivate(Keybind::Keybind_Ctrl, EditorInputScope::EditorInputScope_Operations, false))
		{
			ActivateInputScope(EditorInputScope::EditorInputScope_Ctrl);
		}
		else
		{
			DeactivateInputScope(EditorInputScope::EditorInputScope_Ctrl);
		}

		if (CanActivate(Keybind::Keybind_Shift, EditorInputScope::EditorInputScope_Operations, false))
		{
			ActivateInputScope(EditorInputScope::EditorInputScope_Shift);
		}
		else
		{
			DeactivateInputScope(EditorInputScope::EditorInputScope_Shift);
		}
