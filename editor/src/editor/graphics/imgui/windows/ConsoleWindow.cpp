		...
		namespace imgui
		{
			...
			void ConsoleWindow::Render()
			{
				...
				if (ImGui::IconCheckboxButton(
					ImGui::IMGUI_FORMAT_ID(LogSeverityToIcon(LOGSEVERITY_INFO).c_str(), BUTTON_ID, "SHOW_INFO_CONSOLE").c_str(), &showInfo, "Toggles visibility of informational log messages.", m_Window.GetHeaderSize(), S_ICON_COLORS[LOGSEVERITY_INFO]))
				{
				...
				if (ImGui::IconCheckboxButton(
					ImGui::IMGUI_FORMAT_ID(LogSeverityToIcon(LOGSEVERITY_TEST).c_str(), BUTTON_ID, "SHOW_TEST_CONSOLE").c_str(), &showTest, "Toggles visibility of test log messages used for quick testing.", m_Window.GetHeaderSize(), S_ICON_COLORS[LOGSEVERITY_TEST]))
				{
				...
				if (ImGui::IconCheckboxButton(
					ImGui::IMGUI_FORMAT_ID(LogSeverityToIcon(LOGSEVERITY_WARNING).c_str(), BUTTON_ID, "SHOW_WARNING_CONSOLE").c_str(), &showWarning, "Toggles visibility of warning log messages, indicating potential issues.", m_Window.GetHeaderSize(), S_ICON_COLORS[LOGSEVERITY_WARNING]))
				{
				...
				if (ImGui::IconCheckboxButton(
					ImGui::IMGUI_FORMAT_ID(LogSeverityToIcon(LOGSEVERITY_ERROR).c_str(), BUTTON_ID, "SHOW_ERROR_CONSOLE").c_str(), &showError, "Toggles visibility of error log messages, indicating runtime or critical errors.", m_Window.GetHeaderSize(), S_ICON_COLORS[LOGSEVERITY_ERROR]))
				{
				...
				if (ImGui::IconCheckboxButton(
					ImGui::IMGUI_FORMAT_ID(LogSeverityToIcon(LOGSEVERITY_ASSERT).c_str(), BUTTON_ID, "SHOW_ASSERT_CONSOLE").c_str(), &showAssert, "Toggles visibility of assert messages, typically generated by failed assertions in code.", m_Window.GetHeaderSize(), S_ICON_COLORS[LOGSEVERITY_ASSERT]))
				{
				...
				if (ImGui::IconCheckboxButton(
					ImGui::IMGUI_FORMAT_ID(LogSeverityToIcon(LOGSEVERITY_SUCCESS).c_str(), BUTTON_ID, "SHOW_SUCCESS_CONSOLE").c_str(), &showSuccess, "Toggles visibility of success log messages, often used for visual confirmation of events.", m_Window.GetHeaderSize(), S_ICON_COLORS[LOGSEVERITY_SUCCESS]))
				{
				...
				if (ImGui::IconCheckboxButton(
					ImGui::IMGUI_FORMAT_ID(LogSeverityToIcon(LOGSEVERITY_AWESOME).c_str(), BUTTON_ID, "SHOW_AWESOME_CONSOLE").c_str(), &showAwesome, "Toggles visibility of awesome messages, special messages for notable events or achievements.", m_Window.GetHeaderSize(), S_ICON_COLORS[LOGSEVERITY_AWESOME]))
				{
