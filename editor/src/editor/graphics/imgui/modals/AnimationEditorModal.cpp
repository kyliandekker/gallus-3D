		...
		namespace imgui
		{
			...
			void AnimationEditorModal::Render()
			{
				...
				))
				{
					...
					ImVec2 legendRectSize = ImVec2((m_AnimationTrack.GetFrameCount() * ANIMATION_FRAME_PIXEL_WIDTH) + LEGEND_PADDING + LEGEND_PADDING + LEGEND_PADDING, LEGEND_HEIGHT + LEGEND_PADDING);
