...
namespace gallus
{
	namespace graphics
	{
		namespace imgui
		{
			DirectionalLightEditorSelectable::DirectionalLightEditorSelectable(ImGuiWindow& a_Window) : EditorSelectable(a_Window)
			{
			...
			//---------------------------------------------------------------------
			std::string DirectionalLightEditorSelectable::GetName() const
			{
				return "DirectionalLight";
			}

			//---------------------------------------------------------------------
			std::string DirectionalLightEditorSelectable::GetIcon() const
			{
				return m_sIcon.c_str();
			}

			//---------------------------------------------------------------------
			void DirectionalLightEditorSelectable::RenderEditorFields()
			{
