...
namespace gallus::graphics::imgui
{
	...
	{
		EditorInputScope_Shift = 1 << 7,
		EditorInputScope_Ctrl = 1 << 6,
		EditorInputScope_SpriteSheetHover = 1 << 5,
	...
	inline void ActivateInputScope(EditorInputScope a_InputScope, bool a_bActive)
	{
		if (a_bActive)
		{
			s_EditorInputScopeFlags |= static_cast<uint32_t>(a_InputScope);
