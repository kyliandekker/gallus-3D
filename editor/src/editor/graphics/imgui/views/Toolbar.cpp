...
namespace gallus::graphics::imgui
{
	...
	// Toolbar
	//---------------------------------------------------------------------
	ToolbarButton::ToolbarButton(ImGuiSystem& a_System, std::function<void()> a_ButtonFunc, std::function<bool()> a_DisabledCondition) : ToolbarItem(a_System),
	...
	//---------------------------------------------------------------------
	ToolbarSearchbar::ToolbarSearchbar(ImGuiSystem& a_System, const std::string& a_sID, float a_fWidth, std::function<void(const std::string&)> a_ButtonFunc) : ToolbarItem(a_System),
