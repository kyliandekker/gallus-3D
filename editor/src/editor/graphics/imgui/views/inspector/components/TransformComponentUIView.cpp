			...
			void TransformComponentUIView::RenderInner()
			{
				...
				ImGui::KeyValue([this]
					...
					[this]
					{
						...
						if (m_PositionView.Render("TRANSFORM_COMPONENT_POSITION_INSPECTOR"))
						{
				...
				ImGui::KeyValue([this]
					...
					[this]
					{
						...
						if (m_ScaleView.Render("TRANSFORM_COMPONENT_SCALE_INSPECTOR"))
						{
				...
				ImGui::KeyValue([this]
					...
					[this]
					{
						...
						if (m_PivotView.Render("TRANSFORM_COMPONENT_PIVOT_INSPECTOR", 0.01f, -0.5f, 0.5f))
						{
