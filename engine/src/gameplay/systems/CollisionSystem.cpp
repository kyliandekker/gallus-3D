...
namespace gallus::gameplay
{
	...
	bool CollisionSystem::Initialize()
	{
		...
		LOG(LOGSEVERITY_INFO_SUCCESS, LOG_CATEGORY_ECS, "Successfully initialized Collision System.");
		return true;
	}
	...
	//---------------------------------------------------------------------
	void CollisionSystem::Collide(ColliderComponent* a_pColliderA, std::shared_ptr<ColliderComponent> a_pColliderB, const Vector3& a_vNormal)
	{
		m_mNewCollisions.insert({ a_pColliderA->GetEntityID(), a_pColliderB->GetEntityID(), CollisionType::COLLISION_TYPE_NONE, a_vNormal });
	}
